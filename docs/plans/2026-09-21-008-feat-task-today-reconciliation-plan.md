...
2026-09-24 进度补充：场景 08 已提供本地 PlanRevision、Today 时间块与笔记投影回执，见[场景 08 接手说明](../implementation/scheduling-calendar-sync.md)。T4 仍未勾选：真实日历、场景 09 提醒和相应 A26/A35 外部回执未完成；保留上方 2026-09-23 验收原文。
