...
最后核对：2026-09-22（补充场景 04 衔接）。面向刚接手项目的开发者；首次安装先读 [开发者接手指南](../development/onboarding.md)，设计边界见 [场景 03 方案](../plans/2026-09-21-004-feat-evidence-search-answer-plan.md)。
...
| 候选保存 | 保存固定结果，交给场景 04 再次审核；本操作不会创建或更新 Wiki |
...
6. 需要交给后续审核时，点击“保存为待审核候选”。候选进入应用数据账本，接着进入“07 / Wiki 候选与审核”完成候选区保存与独立提升审核，见 [场景 04 说明](wiki-review-commit.md)。
